...
parser.add_argument("--prob_dir", type=str, default='./ROSE-2/predict/prob/', help="path to folder for saving probability maps")
parser.add_argument("--pred_dir", type=str, default='./ROSE-2/predict/pred/', help="path to folder for saving prediction maps")
parser.add_argument("--gt_dir", type=str, default='./ROSE-2/test/gt/', help="path to folder for saving ground truth")
